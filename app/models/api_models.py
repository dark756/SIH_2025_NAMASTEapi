...
class ProcessingResult(APIResponse):
    ...
    emr_output: Optional[List[Dict[str, Any]]] = Field(
        default=None,
        description="Converted EMR records in dictionary format"
    )

    emr_statistics: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Statistics from EMR conversion process"
    )
